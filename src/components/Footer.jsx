...
const Footer = () => {
  return (
    <div>
    <footer id='footer' className="bg-gray-700 mt-6 text-white">
        ...
        <div className="flex">
          ...
          <div className="w-full md:w-1/4 lg:w-1/4 mb-8">
            ...
            <ul className="list-reset">
              ...
              <li className="inline-block mr-4"><a href='/' className="text-white text-2xl hover:text-white"><FaInstagram></FaInstagram></a></li>
              </ul>
          </div>
        </div>
      </div>
