...
const Navbar = () => {
  ...
  return (
    <div id="navbar" className="relative z-20">
      <nav className="sticky text-amber-400 shadow-xs h-16 py-4 px-6 flex justify-between items-center bg-white">
        <div className="font-bold text-xl">
          <Link href="/">Samosa Delivery</Link>
        </div>
        <ul className="flex items-center font-medium text-lg">
          <li className="mx-2">
            <Link
              href="/menu"
              className="hover:border-amber-400 border pr-2 border-transparent inline-flex rounded p-1 px-1.5 hover:border"
            >
          ...
          <li className="mx-2">
            <Link
              href="/about"
              className="hover:border-amber-400 pr-2 border-transparent inline-flex border rounded p-1 px-1.5 hover:border"
            >
              <BsFillPersonFill className="mt-1.5 mr-1.5 text-xl" />
              <p className="mt-0.5">About</p>
            </Link>
          </li>
          <li className="mx-2">
            <Link
              href="/wishlist"
              className="hover:border-amber-400 border border-transparent pr-2 mt-0.5 inline-flex p-1 rounded px-1.5 hover:border"
            >
          ...
          <li className="mx-2 text-lg">
            <Link
              href="/contact"
              className="hover:border-amber-400 pr-2 border border-transparent mt-0.5 rounded inline-flex p-1 px-1.5 hover:border"
            >
          ...
          <li className="ml-4 text-lg">
            {user ? (
                ...
                <div>
                  <div className="relative">
                    <button
                      ...
                      aria-expanded="false"
                    >
                      <BiUserCircle className="text-2xl mr-1.5" />
                      {userName.split(" ").slice(0, 1)}
                    </button>
                    <ul className="fixed z-20 peer-hover:mt-2 hover:block peer-hover:block hidden mt-2 min-w-max list-none rounded-lg border-none bg-white bg-clip-padding text-left text-base shadow-lg dark:bg-neutral-700">
                      <li>
                        <a
              ...
              <Link
                href="/auth/signup"
                className="border-amber-400 -ml-1 mr-4 pr-3 inline-flex border rounded p-1 px-2 hover:bg-amber-400 hover:text-white text-amber-400"
              >
