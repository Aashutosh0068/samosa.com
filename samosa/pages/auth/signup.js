                    ...
                    <div className="p-6 min-h-max rounded-xl space-y-4 md:space-y-6 sm:p-8 opacity-75 border">
                        ...
                        <form className="space-y-4 md:space-y-6" onSubmit={(e) => e.preventDefault() & handleSubmit()}>
                            ...
                            <div>
                                ...
                                <input type="cpassword" readOnly value={password} name="cpassword" id="cpassword" placeholder="••••••••" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-md rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" />
                            </div>
