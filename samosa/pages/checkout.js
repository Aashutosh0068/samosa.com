              ...
              <div className=" opacity-95 mx-10 border lg:my-16 bg-white-50 shadow-xl rounded-lg max-w">
                <div className="md:flex ">
                  <div className="w-full p-5 px-8 py-8">
                    ...
                    <h3 className="mb-4 font-semibold mt-4 text-gray-900 dark:text-white">
                      Payment Method
                    </h3>
                    <ul className="items-center w-full mb-5 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg sm:flex dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                      ...
                      <li className="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                        <div className="flex items-center pl-3">
                          <input
                            ...
                            name="list-radio"
                            className="w-4 h-4 text-amber-400 bg-gray-100 border-gray-300 focus:ring-amber-400 dark:focus:ring-amber-400 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"
                          />
                          <label
